              ...
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1 space-y-4">
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className="text-sm font-medium text-gray-600 dark:text-gray-600 dark:text-gray-900 dark:text-white/70 mb-1 block">Email</label>
                      <Input
                        type="email"
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      <label className="text-sm font-medium text-gray-600 dark:text-gray-600 dark:text-gray-900 dark:text-white/70 mb-1 block">Phone Number</label>
                      <Input
